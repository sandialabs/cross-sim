...
# Use this file to produce a list of DAC (min, max) ranges for each layer of CN6_v2 for MNIST
...
profiling_folder = "./adc_dac_inputs/DACinputs_mnist_CNN6_v2/"
# npy output file path
output_name = "./adc_limits/examples/CNN6v2_DAC_limits.npy"
