...
class ResNet(nn.Module):
    """Torch implementation designed to mimic MLPerf implementation."""
...
def _resnet(arch, block, layers, pretrained, ckpt_file, **kwargs):
...
def resnet50(pretrained=False, ckpt_file=None, **kwargs):
    """ResNet-50 model.

    Model from: "Deep Residual Learning for Image Recognition"
    ...
    """
    return _resnet(
        "resnet50", Bottleneck, [3, 4, 6, 3], pretrained, ckpt_file, **kwargs
    )
