...
from simulator.devices.models.generic_device import NormalError
from simulator.backend import ComputeBackend
from simulator.parameters.device import DeviceParameters
from simulator.parameters.device.types import PCMJoshiParameters

xp = ComputeBackend()


class PCMJoshi(BaseDevice):
    ...
    def __init__(
        ...
        model_params: PCMJoshiParameters,
    ):
    ...
    def drift_error(self, input_, time):
        # No drift model
        raise ValueError(
            "PCM Joshi is not a valid drift model. "
