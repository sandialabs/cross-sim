...
class IdealDACParameters(DACParameters):
    """Parameters for the ideal digital-to-analog converter.

    The ideal case requires no extra parameters. This parameter exists to follow
    the patterns of other custom circuit parameters.
